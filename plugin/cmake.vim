...
" command! -nargs=+ CMakeWorkflowListPresetVariables call cmake#workflow_list_preset_variables(<f-args>)
...
" nnoremap <silent> <Plug>(CMakeWorkflowListPresetVariables) : call cmake#list_preset_variables(default)<CR>
